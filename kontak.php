...
<div id="support" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Tinggalkan Kesan dan pesan anda kepada pelayanan aplikasi kami kepada anda <br>Komentar anda akan membangun negri ini menjadi lebih baik</p>
            </div><!-- end title -->
					...
					<div class="right-box-contact">
						...
						<div class="support-info">
							<div class="info-title">
								...
								Address
								<span>PO Box 16122 Jln.Jendral Suparman, Padang, Indonesia</span>
							</div>
						</div>
					</div>
				</div><!-- end col -->
