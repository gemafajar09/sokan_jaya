...
$laporan= mysqli_query($koneksi,"SELECT * FROM tbl_pemesanan a LEFT JOIN tbl_jadwal b ON a.id_rute=b.id_rute LEFT JOIN tbl_penumpang c ON a.id_penumpang=c.id_penumpang LEFT JOIN tbl_loket d ON a.id_loket=d.id_loket LEFT JOIN tbl_rute e ON a.id_rute=e.id_rute WHERE Date_format(tanggal_pesan,'%Y')='$thn'");
$no=1;
?>
  <tr  align="center">
  ...
  <th><img src="images/logo2.png" width="150px" height="150px" align="left"> </th>
            ...
            </h3>JL. DR. Sutomo, Kubu Marapalam, Kubu Marapalam, Kec. Padang Tim., Kota Padang, Sumatera Barat 25143<br><b>Laporan Tahunan</b>
...
<table class="table-bordered table table-striped " border="1" cellspacing="0" cellpadding="0" align="center"
    ...
    <?php } ?>
    <?php 
        $laporan= mysqli_query($koneksi,"SELECT SUM(jumlah_bayar) AS sayang FROM tbl_pemesanan WHERE Date_format(tanggal_pesan,'%Y')='$thn'");
        while ($xx = mysqli_fetch_array($laporan)){
