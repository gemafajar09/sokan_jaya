        ...
        <div class="container-fluid">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Laporan Data Loket</h3>
            </div>
            <div class="box-header with-border">          
              <tr>
                <form action="cetak_lap_loket.php" method="POST" target="_blank">
                   <div class="form-group-inner">
                    <div class="row">
                    <td>
                        <div class="col-lg-9">
                          <td>
                    		<button name="print" class="btn btn-sm btn-primary login-submit-cs" type="submit"><i class
                            ="fa fa-print">Print Laporan</i></button>
                			</td>
                        </div>
                	</td>
                    </div>
